...
\begin{definition}[Partially ordered set]
  ...
  \begin{enumerate}
    ...
    \item if $x \le y$ and $y \le x$, then $x = y$ ($\forall x,y \in P$)
    \item if $x \le y$ and $y \le z$, then $x \le z$ ($\forall x,y,z \in P$)
  \end{enumerate}
\end{definition}
...
\paragraph{}
In the figure, there is a link between $a$ and $b$ so $a \le b$, and $b \le d$. So $a \le d$ by transitivity, even if there is no line between thoses points.
