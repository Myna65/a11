...
\begin{proof}
  ...
  \paragraph{}
  If the sequence is extended, the possible adjacent squares are $[\rho_0,\rho_3]$, $[\rho_2, \rho_3]$ or $[\rho_0, \rho_2]$ but in all cases, it uses $\rho_1$ or $\rho_2$ edges and thus some $\rho_0$ or $\rho_3$ edge must be placed in atlernating squares but there are not enough points.
