...
\begin{proof}
  ...
  \paragraph{}
  There are three posiibilities to link both component a chain $\rho_0, \rho_1$, a chain $\rho_2, \rho_1$ or a chain $\rho_3, \rho_1$. The last case is the dual of the first case.
