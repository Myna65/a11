...
\begin{proof}
  ...
  \paragraph{}
  The involution $\rho_0$ must commute with $\rho_3$. The involution $\rho_0$ cannot double the single $\rho_3$ edge. not be connected to any vertex of this edge. It cannot double $\rho_1$ but one point is missing. It must use at least one point of this edge. It is a single $\rho_0$ edge. It must only be connected to a fixed point.
