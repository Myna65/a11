...
\begin{proof}
  ...
  \paragraph{}
  Also by Lemma~\ref{rank-4-3-patterns}, we know that $\rho_0$ and $\rho_2$ must commute. Thus there are at least two alternating squares. There are some possibilities for the relations between both squares.
