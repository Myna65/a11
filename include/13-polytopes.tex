...
\begin{proposition}
  ...
  \begin{enumerate}
    ...
    \item ("Diamond property")\index{diamond property} Given two faces $F$ and $G$ of $P$ such that $\dim(F) = \dim(G) - 2$ there exists exactly two faces $H_1$ and $H_2$ such that $F < H_1 < G$ and $F < H_2 < G$.
  \end{enumerate}
\end{proposition}
