...
\begin{definition}[Generating set of a group]
  ...
  \index{generator}
  It is said that a set generates a group if all elements of the group can be written as a product of elements of this set. The elements of this set are called \textit{generators} Conversely, no element outside the group must be written as a product of the generators.
\end{definition}
