...
\paragraph{}
When placing the $\rho_3$ edge we made a choice among three possibilities, for the $\rho_1$ edge it was among two possibilities. Thus in total the are 6 graphs. The construction of the five other graphs is left to the reader. He can check that the built graphs match the graphs of appendix~\ref{monodromy-5}.
