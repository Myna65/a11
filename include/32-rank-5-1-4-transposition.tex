...
\begin{proof}
  ...
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
      \caption{First possibility for $\Gamma_{I}$}
    \end{center}
  \end{figure}
  ...
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
      \caption{Second possibility for $\Gamma_{I}$}
    \end{center}
  \end{figure}

  \paragraph{}
  In the first graph, the permutation $(\rho_1 \rho_2)^2 \rho_1$ is $(a~b)(d~e)$. Thus this permutes only 4 out of the 8 points of $\rho_2$.

  \paragraph{}
  In the second graph, $(\rho_1\rho_2)^4 \rho_1 = (b~c)(d~e)$ gives the same result.

  \paragraph{}
  With $J$, the disposition of the edges alongside the alternating square is very important. Therefore there are 3 possibilities among the six graphs:
  ...
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
      \caption{First possibility for $\Gamma_{J}$}
      \label{S2-1}
    \end{center}
  \end{figure}
  ...
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
      \caption{Second possibility for $\Gamma_{J}$}
    \end{center}
  \end{figure}
