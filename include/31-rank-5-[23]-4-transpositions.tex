...
\paragraph{}
Now we have found a set of possible permutation representation group. But in all those four graphs one generator can be written as a product of other generators. To demonstrate this, we will only choose some edges of the graphs.
